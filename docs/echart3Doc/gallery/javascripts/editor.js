...
function load() {
	if(IS_STATIC) return void(configs.c && $.ajax("./data/" + configs.c + ".js", {
		dataType: "text",
		success: function(e) {
			gb.loadedCode = e, gb.editor.setValue(e, -1)
		}
	}).fail(function() {
		log("加载图表失败！", "error")
	}));
...
function downloadExample() {
	var e = '<!DOCTYPE html>\n<html style="height: 100%">\n   <head>\n       <meta charset="utf-8">\n   </head>\n   <body style="height: 100%; margin: 0">\n       <div id="container" style="height: 100%"></div>\n       <script type="text/javascript" src="http://10.122.3.58:8081/lib/echart/echart3Doc/gallery/vendors/echarts/echarts-all-3.js"></script>\n       <script type="text/javascript" src="http://10.122.3.58:8081/lib/echart/echart3Doc/gallery/vendors/echarts/extension/dataTool.min.js"></script>\n       <script type="text/javascript" src="http://10.122.3.58:8081/lib/echart/echart3Doc/gallery/vendors/echarts/map/js/china.js"></script>\n       <script type="text/javascript" src="http://10.122.3.58:8081/lib/echart/echart3Doc/gallery/vendors/echarts/map/js/world.js"></script>\n       <script type="text/javascript" src="http://10.122.3.58:8081/lib/echart/echart3Doc/gallery/vendors/echarts/extension/bmap.min.js"></script>\n       <script type="text/javascript">\nvar dom = document.getElementById("container");\nvar myChart = echarts.init(dom);\nvar app = {};\noption = null;\n' + gb.editor.getValue() + ';\nif (option && typeof option === "object") {\n    myChart.setOption(option, true);\n}\n       </script>\n   </body>\n</html>',
		t = new Blob([e], {
...
var appEnv = {},
	gui, run = function(ignoreOptionNotChange) {
		if(hasEditorError()) return void log("编辑器内容有误！", "error");
		localSave(), clearTimeout(appEnv.timeTicket), clearInterval(appEnv.timeTicket), appEnv.config = null;
		try {
