...
! function(e, t) {
	...
	return h.noConflict = function(t) {
		...
		function o(e) {
			...
			return a(r.defineProperties, e._define), e._define = null, r.implement(e), o._applySuper = i, o._superClass = n, o.constructor = r, r
		}
		...
		return t.newClass = function(e) {
			var t = function() {
				return f(this._construct) ? this._construct.apply(this, arguments) : this
			};
			return t.extend = o, t.implement = u, a(t.defineProperties = {}, e._define), e._define = null, t.implement(e), t.uid = "Class_" + n.localUID(), t.prototype._prop = s, t
		}, t.simpleInherit = function(e, t) {
			var n = e.prototype,
				r = new Function;
			r.prototype = t.prototype;
			var s = e.prototype = new r;
			return a(s, n), s._applySuper = i, s._superClass = t, s.constructor = e, e
		}, t
	...
	function e(t, n, r) {
		...
		function u(e, t) {
			var r = n.getComponent(e);
			r ? r.viewModel("visible")(t) : e[t ? "show" : "hide"]()
		}

		function a(e, t) {
			var r = n.getComponent(e);
			r && r.viewModel("disabled")(t)
		}
		var t = e("jquery"),
			n = e("../lib"),
			r = e("./Component"),
			...
			o = r.extend({
				...
				_init: function() {
					...
					this._disposable(t.subscribe(function(e) {
						this._changeTabByModel(e, i(n))
					}, this)), this._useTab1() && this._disposable(n.subscribe(function(e) {
						this._changeTabByModel(i(t), e)
					}, this)), this.bind()
				},
				bind: function() {
					if(this._prop("bound")) throw new Error("It has been bound.");
					var e = this._viewModel();
					this._bindDom(), this._changeTabByModel(i(e.currentTab), i(e.currentTab1)), this._bindModelUpdater(), this._prop("bound", !0)
				},
				unbind: function() {
				...
				setTabDisabled: function(e, t, n) {
					var r = this._viewModel(),
						i = this._getTabWrap(t, n);
					i.$tabEl[e ? "addClass" : "removeClass"](r.headItemDisabledCss), i.$conEl[e ? "addClass" : "removeClass"](r.conItemDisabledCss), a(i.$conEl, e)
				},
				...
				setTabLabel: function(e, t) {
					var n = this._prop("tabWraps");
					n[e].$tabEl[0].innerHTML = t
				},
				_bindDom: function() {
					var e = this._prop("tabWraps", {}),
						...
						l = n.find("*[data-" + i + "]"),
						c = f && n.find("*[data-" + s + "]"),
						h = n.find("*[data-" + r.conAttr + "]");
					l.each(function(n, o) {
						var u = t(o);
						u.addClass(r.headItemCss), f ? c.each(function(n, o) {
							var a = t(o);
							a.addClass(r.headItemCss1);
							var f = e[u.data(i)] || (e[u.data(i)] = {});
							f[a.data(s)] = {
								$tabEl: u,
								$tabEl1: a
							}
						...
						var s = t(i);
						s.addClass(r.conItemCss), u(s, !1), f ? e[s.data(o)][s.data(a)].$conEl = s : e[s.data(o)].$conEl = s
					})
				},
				_unbindDom: function() {
					this._prop("tabWraps", {})
				...
				_removeCurrSelect: function() {
					...
					n && (n.$tabEl.removeClass(e.currentHeadItemCss), t && n.$tabEl1.removeClass(e.currentHeadItemCss1), u(n.$conEl, !1), this._prop("currentTabKey", null), t && this._prop("currentTabKey1", null))
				},
				_addSelect: function(e, t) {
					var n = this._viewModel(),
						r = this._useTab1(),
						i = this._getTabWrap(e, t);
					i && (i.$tabEl.addClass(n.currentHeadItemCss), r && i.$tabEl1.addClass(n.currentHeadItemCss1), u(i.$conEl, !0), this._prop("currentTabKey", e), r && this._prop("currentTabKey1", t))
				},
				...
				_bindModelUpdater: function() {
					var e = this._viewModel(),
						...
						i = this,
						s = this.$el();
					s.on(this._event("click"), "*[data-" + n + "]", function() {
						var r = t(this).data(n);
						r !== i._prop("currentTabKey") && e.currentTab(r)
					}), s.on(this._event("click"), "*[data-" + r + "]", function() {
						var n = t(this).data(r);
						n !== i._prop("currentTabKey1") && e.currentTab1(n)
					})
				},
		...
		var p = "APIMain",
			...
			w = ".ecdoc-quick-link",
			E = "ecdoc-api-doc-line-expand",
			S = "ecdoc-api-doc-line-head",
			x = "ecdoc-api-doc-group-line-highlight",
			T = "ecdoc-api-doc-sub-group",
			N = c.down,
			C = c.left,
			k = "ecdoc-api-doc-group-line",
			L = /<iframe[^>]*>.*?<\/iframe>/g,
			A = !0,
			O = {},
			M;
		O.init = function() {
			M = new _(t(".ecdoc-apidoc"))
		};
		var _ = n.extend({
			_define: {
			...
			_initHash: function() {
				function t(t) {
					A && P({
						key: "initHash",
						data: t
					}), t || (t = o.getGlobalArg("initHash", "")), t && e._handleHashQuery(t), A = !1
				}
				var e = this;
				a.initHash(t)
			},
			...
			_prepare: function() {
				function e(e, t) {
					this._prepareDoc(e), this._applyTpl(this.$el(), p), this._initQuickLink(), this._initTree(), this._initQueryBox(), this._initDescArea(), this._initHash(), this._initScroll()
				}
			...
			_initQuickLink: function() {
				var e = [
					...
					t = [];
				for(var n = 0; n < e.length; n++) t.push(o.getGlobalArg("pageName") === e[n][0] ? "<span>" + e[n][1] + "</span>" : '<a href="' + e[n][0] + '.html">' + e[n][1] + "</a>");
				this.$el().find(w)[0].innerHTML = t.join("")
			},
			_initTree: function() {
				function n(e, t, n) {
				...
				function r(e, t, n) {
					var r = n.getTreeDataItem(!0),
						s = this.$el();
					e && r && (this._updateDescArea(r), A || P({
						key: "clickTreeItem",
						data: r.optionPathForHash
					}), i.call(this, r), s.find("." + x).removeClass(x), this._findDescNode(r.value).addClass(x), r.optionPathForHash && a.hashRoute({
			...
			_initQueryBox: function() {
				function u(t) {
					...
					e.viewModel("placeholder")(r.placeholder), f.call(this, !0)
				}
				...
				function f(e, t, n) {
					var o = r(),
						u = r.peekValueInfo();
					if(!u) return;
					u.type === i.valueInfo.CONFIRMED && (e || P({
						key: "search",
						data: o,
						queryMode: s()
					}), o && this._confirmQuery(o, s(), !1, !0))
				}
				...
				var e = this._sub("queryInput"),
					...
					r = e.viewModel("value");
				r.subscribe(t.proxy(f, this, !1));
				var s = n.viewModel("checked");
				s.subscribe(u, this), u.call(this, s()), this._sub("collapseAll").on("click", t.proxy(l, this)), t(document).keypress(function(t) {
					var n = (t.target.tagName || "").toLowerCase();
					t.which === 47 && n !== "input" && n !== "textarea" && (e.focus(), e.select(), t.preventDefault())
				});
				var o = this;
				e.$el().find("input").autoComplete({
					minChars: 1,
					source: function(e, t) {
						var n = e ? o._doQuery(e, s()) : [],
							r = [];
						for(var i = 0; i < n.length; i++) r.push(n[i].optionPathForHash);
						t(r)
					},
			...
			_initDescArea: function() {
				function n(t) {
					...
					r.subGroup[0].style.display === "none" ? (P({
						key: "expandDesc",
						data: s
					}), r.expandBtn[0].innerHTML = N, r.subGroup.slideDown().promise().always(e)) : (P({
						key: "collapseDesc",
						data: s
					}), r.expandBtn[0].innerHTML = C, r.subGroup.slideUp().promise().always(e))
				}
				this.$el().find(g).on("click", "." + E, t.proxy(n, this)), this.$el().find(g).on("click", "." + S, t.proxy(n, this));
			...
			_findDescNode: function(e) {
				...
				return this.$el().find("." + k).filter(function(t, i) {
			...
			_doExpand: function(e, n, r) {
				...
				o.each(function(e, n) {
					...
					if(!r.subGroup.length) return;
					r.expandBtn[0].innerHTML = N, r.subGroup.show()
				})
			},
			...
			_handleHashQuery: function(e) {
				...
				if(!t || e !== t.optionPathForHash) A || P({
			...
			_doQuery: function(e, t) {
				try {
					var n = {};
					return n[t] = e, r.queryDocTree(this._docTree, n) || []
				} catch(i) {
					return alert(i), []
				}
			},
			_confirmQuery: function(e, n, r, i) {
				var s = this._doQuery(e, n);
				i && this._setResultInfo(s.length);
				var o = null;
				t(v).each(function() {
					this.checked && this.value === "1" && (o = 2)
				});
				if(!s.length) return;
				var u = [];
				for(var a = 0, f = s.length; a < f; a++) u.push(s[a].value);
				...
				r ? l.apiTreeSelected(s[0].value, c) : l.apiTreeHighlighted(u, c)
			},
